module Lib (Point, PointBig, newPoint, newPoint3, getX, getY, getZ, manhattan, neighbours, neighbours3, Range, newRange, getMin, getMax, merge, includes, overlaps, compress) where
...
overlaps r1@(Range a b) r2@(Range c d) = includes a r2 || includes b r2 || includes c r1 || includes d r2
